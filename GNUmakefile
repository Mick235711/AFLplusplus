...
afl-tmin: src/afl-tmin-delta.cpp src/sbfl.cpp src/afl-tmin.o src/afl-common.o src/afl-sharedmem.o src/afl-forkserver.o src/afl-performance.o $(COMM_HDR) | test_x86
	$(CXX) $(CXXFLAGS) -O3 -Iinclude -o $@ src/afl-tmin-delta.cpp src/sbfl.cpp src/afl-common.o src/afl-sharedmem.o src/afl-forkserver.o src/afl-performance.o src/afl-tmin.o
